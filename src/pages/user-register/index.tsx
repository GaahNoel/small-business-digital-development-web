    ...
    <>
      <Flex bg="secondary" direction="column" minHeight="100vh">
        <Box width="100%" display={{base: "block", lg: "none"}}>
          <HeaderHalfCircleTop>
            <Flex width="100%" maxWidth={{base: "300px", sm: "350px"}} direction="column">
              <Stack direction="row" align="center" spacing={3}>
                <Heading as="h2" fontSize={{base: "24px", sm: "30px", md: "36px"}} color="default_white">
                  Acesse já!
                </Heading>
                <Icon as={FaShoppingBag} fontSize={{base: "25px", sm: "32px", md: "38px"}} color="secondary"></Icon>
              </Stack>
              <Text align="end" fontSize={{base: "16px", sm: "20px", md: "23px"}} color="default_white">
