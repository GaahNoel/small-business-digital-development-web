...
export const PrincipalButton = ({
  ...
  return (
    <Button
      bg={colorButton}
      color={colorText}
      _hover={{ bgColor: `${colorButton}_hover`, 'svg': {animation: "drawIcons 3s ease 1", animationFillMode: "backwards"}, '@keyframes drawIcons': { "0%": {strokeWidth: 0, strokeDasharray: "1 100"}, "100%": {strokeWidth: 1.5, strokeDasharray: "100 0"} } }}
      variant="solid"
      borderRadius="lg"
    ...
    >
      <Stack direction="column" align="center" spacing={2} id={text}>
        <Icon as={icon} fontSize={{base: "3rem", md: "3.5rem", lg: "5rem", xl: "6rem"}} color={colorText} strokeWidth="1.5" />
