...
export const export_default_orange_hover = darken(0.2, default_orange);
export const service_blue = '#4FAAFF';
export const export_service_blue_hover = darken(0.2, service_blue);
export const default_yellow = '#F2B705';
export const export_default_yellow_hover = darken(0.2, default_yellow);
export const default_gray = '#808080';
export const empty_gray = '#ABABAB';
...
export const Theme = extendTheme({
  semanticTokens: {
    colors: {
      ...
      default_white_min_hover: darken(0.05, default_white),
      default_black,
      ...
      empty_gray,
      empty_gray_hover: darken(0.2, empty_gray),
      success_green,
